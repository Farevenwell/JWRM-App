					...
					<center>
						<table class="tblListForm">
							...
							<tr class="<?php if(isset($junkers)) echo $junkers;?>">
								...
								<td><center><a href="report2.php?shop_id=<?php echo $row["shop_id"]; ?>" class="link"><img alt='Edit' title='Generate Report' src='images/gen.png' width='20%' height='40px' /></a></center></td>
							</tr>
										<?php
									$i++;
									}
