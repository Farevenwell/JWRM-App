    ...
    <?php
		include("db.php");
			$sql = "SELECT * FROM accounts where user_type ='Main'";
			$result = $conn->query($sql);
	?>
	<center><h2><b>Registered Main Admin<a onclick="myFunction1()"><img alt='Minimize' title='Minimize' src='images/mini.png' width='30px' height='30px' /></a></i></b></h2></center>
				<div id="main1">
					<table width="100%" class="tblListForm">
								<tr class="listheader">
										<td><b><h3><center>Main Admin ID</center></h3></td>
								...
								?>
										<tr class="<?php if(isset($junkers)) echo $junkers;?>">
											...
											<td><center><a href="remove_admin.php?account_id=<?php echo $row["account_id"]; ?>"  class="link"><img alt='Delete' title='Delete' src='images/delete.png' width='30px' height='30px'/></a></center></td>
											<?php
									$i++;
									}
								?>
